...
Use the linehash MCP for all read,edit,replace,...content in file that tool uses content-hashed line anchors (`12:ab3f`) instead of fragile exact-text matching
