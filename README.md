...
- Stash create/apply/drop, stash-options menu parity for tracked, include-untracked, staged, and unstaged creation, reflog restore, and worktree create/remove flows
