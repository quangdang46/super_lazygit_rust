...
- Stash create/apply/pop/drop, stash-options menu parity for tracked, keep-index, include-untracked, staged, and lazygit-style unstaged creation, reflog restore, and worktree create/remove flows
