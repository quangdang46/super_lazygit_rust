// Ported from ./references/lazygit-master/pkg/gui/context/reflog_commits_context.go
...
impl Default for ReflogCommitsContext {
    fn default() -> Self {
        Self::new()
    }
}

impl IBaseContext for ReflogCommitsContext {
...
impl Context for ReflogCommitsContext {
...
impl DiffableContext for ReflogCommitsContext {
...
impl IListContext for ReflogCommitsContext {
...
impl IList for ReflogCommitsContext {
    fn len(&self) -> usize {
        0
    }
...
impl HasUrn for ReflogCommitsContext {
    fn urn(&self) -> String {
        self.key.clone()
    }
}

impl crate::types::context::ParentContexter for ReflogCommitsContext {
