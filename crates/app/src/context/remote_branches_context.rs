// Ported from ./references/lazygit-master/pkg/gui/context/remote_branches_context.go
...
impl Default for RemoteBranchesContext {
    fn default() -> Self {
        Self::new()
    }
}

impl IBaseContext for RemoteBranchesContext {
...
impl Context for RemoteBranchesContext {
...
impl DiffableContext for RemoteBranchesContext {
...
impl IListContext for RemoteBranchesContext {
...
impl IList for RemoteBranchesContext {
    fn len(&self) -> usize {
        0
    }
...
impl HasUrn for RemoteBranchesContext {
    fn urn(&self) -> String {
        self.key.clone()
    }
}

impl crate::types::context::ParentContexter for RemoteBranchesContext {
