// Ported from ./references/lazygit-master/pkg/gui/context/remotes_context.go
...
impl Default for RemotesContext {
    fn default() -> Self {
        Self::new()
    }
}

impl IBaseContext for RemotesContext {
...
impl Context for RemotesContext {
...
impl DiffableContext for RemotesContext {
...
impl IListContext for RemotesContext {
...
impl HasUrn for RemotesContext {
    fn urn(&self) -> String {
        self.key.clone()
    }
}

impl crate::types::context::ParentContexter for RemotesContext {
