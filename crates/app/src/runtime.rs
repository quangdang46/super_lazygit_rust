...
fn git_command_summary(command: &GitCommand) -> &'static str {
    match command {
        ...
        GitCommand::StartGitFlow { branch_type, .. } => match branch_type {
            super_lazygit_core::GitFlowBranchType::Feature => "start_git_flow_feature",
            super_lazygit_core::GitFlowBranchType::Hotfix => "start_git_flow_hotfix",
            super_lazygit_core::GitFlowBranchType::Bugfix => "start_git_flow_bugfix",
            super_lazygit_core::GitFlowBranchType::Release => "start_git_flow_release",
        },
