...
- Branches detail: `select_next_branch`, `select_previous_branch`, `open_selected_branch_commits`, `checkout_selected_branch`, `checkout_previous_branch`, `open_checkout_branch_prompt`, `open_create_branch_prompt`, `open_rename_branch_prompt`, `delete_selected_branch`, `open_set_branch_upstream_prompt`, `toggle_comparison_selection`, `clear_comparison`
- Commits detail: `select_next_commit`, `select_previous_commit`, `copy_selected_commit_hash`, `open_selected_commit_in_browser`, `open_commit_log_options`, `start_interactive_rebase`, `amend_selected_commit`, `fixup_selected_commit`, `reword_selected_commit`, `cherry_pick_selected_commit`, `revert_selected_commit`, `soft_reset_to_selected_commit`, `mixed_reset_to_selected_commit`, `hard_reset_to_selected_commit`, `toggle_comparison_selection`, `clear_comparison`
