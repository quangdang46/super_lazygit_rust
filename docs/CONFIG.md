...
- Branches detail: `select_next_branch`, `select_previous_branch`, `checkout_selected_branch`, `checkout_previous_branch`, `open_checkout_branch_prompt`, `open_create_branch_prompt`, `open_rename_branch_prompt`, `delete_selected_branch`, `open_set_branch_upstream_prompt`, `toggle_comparison_selection`, `clear_comparison`
